...
export class CompanyService {
    ...
    async updateCompanyProfile(CreateCompanyProfileDto : CreateCompanyProfileDto, email : string): Promise<CompanyProfile>
    {
        const companyProfile = await this.companyProfileRepository.findOne({where: {email: email}});
